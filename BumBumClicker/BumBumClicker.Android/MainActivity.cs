...
namespace BumBumClicker.Droid
{
    [Activity(Label = "BumBumClicker", Icon = "@drawable/icon", Theme = "@style/MainTheme", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
